...
const BotName = 'Yahya17Botz'; 
const instagram = 'yahya17_ch'; 
const aktif = 'Kapan bot aktif';
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:YAHYA\n' // yahya
            + 'ORG:Yahya17Botz;\n' // Yahya17Botz
            + 'TEL;type=CELL;type=VOICE;waid=6285784715971:+62 857-8471-5971\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
...
//Hay gay
//create @yahya17 ch don't delate this please
